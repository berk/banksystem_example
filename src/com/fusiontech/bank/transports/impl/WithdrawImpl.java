...
public class WithdrawImpl
    extends com.fusiontech.bank.transports.impl.WithdrawTransportRequestImpl
    implements com.fusiontech.bank.transports.Withdraw, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.fusiontech.bank.model.impl.runtime.UnmarshallableObject, com.fusiontech.bank.model.impl.runtime.XMLSerializable, com.fusiontech.bank.model.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.fusiontech.bank.transports.Withdraw.class);
    }
    ...
    public com.fusiontech.bank.model.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.fusiontech.bank.model.impl.runtime.UnmarshallingContext context) {
        return new com.fusiontech.bank.transports.impl.WithdrawImpl.Unmarshaller(context);
    }

    public void serializeBody(com.fusiontech.bank.model.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://www.fusiontech.com/bankservice/transports/xsd/1.0", "withdraw");
...
+"\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\bwithdrawq\u0000~\u0000;sr\u0000\"com.sun.msv.grammar.Ex"
...
+"mq\u0000~\u0000\fq\u0000~\u0000\u0012x"));
        ...
        extends com.fusiontech.bank.model.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.fusiontech.bank.transports.impl.WithdrawImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        if (("withdraw" == ___local)&&("http://www.fusiontech.com/bankservice/transports/xsd/1.0" == ___uri)) {
                    ...
                    case  1 :
                        if (("cardNumber" == ___local)&&("http://www.fusiontech.com/bankservice/transports/xsd/1.0" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.fusiontech.bank.transports.impl.WithdrawTransportRequestImpl)com.fusiontech.bank.transports.impl.WithdrawImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.fusiontech.bank.transports.impl.WithdrawTransportRequestImpl)com.fusiontech.bank.transports.impl.WithdrawImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.fusiontech.bank.transports.impl.WithdrawTransportRequestImpl)com.fusiontech.bank.transports.impl.WithdrawImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.fusiontech.bank.transports.impl.WithdrawTransportRequestImpl)com.fusiontech.bank.transports.impl.WithdrawImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.fusiontech.bank.transports.impl.WithdrawTransportRequestImpl)com.fusiontech.bank.transports.impl.WithdrawImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
