...
public class VerifyDepositTransportRequestImpl
    extends com.fusiontech.bank.transports.impl.TransactionTransportRequestImpl
    implements com.fusiontech.bank.transports.VerifyDepositTransportRequest, com.sun.xml.bind.JAXBObject, com.fusiontech.bank.model.impl.runtime.UnmarshallableObject, com.fusiontech.bank.model.impl.runtime.XMLSerializable, com.fusiontech.bank.model.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.fusiontech.bank.transports.VerifyDepositTransportRequest.class);
    }
    ...
    public com.fusiontech.bank.model.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.fusiontech.bank.model.impl.runtime.UnmarshallingContext context) {
        return new com.fusiontech.bank.transports.impl.VerifyDepositTransportRequestImpl.Unmarshaller(context);
    }
...
+"\u0000\u0005q\u0000~\u0000%q\u0000~\u0000eq\u0000~\u0000lq\u0000~\u0000yq\u0000~\u0000\tq\u0000~\u0000<q\u0000~\u0000kq\u0000~\u0000\u0007q\u0000~\u0000\u0010x"));
        ...
        extends com.fusiontech.bank.model.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.fusiontech.bank.transports.impl.VerifyDepositTransportRequestImpl.this;
        }
                ...
                switch (state) {
                    case  0 :
                        if (("cardNumber" == ___local)&&("http://www.fusiontech.com/bankservice/transports/xsd/1.0" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.fusiontech.bank.transports.impl.TransactionTransportRequestImpl)com.fusiontech.bank.transports.impl.VerifyDepositTransportRequestImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        break;
                    case  0 :
                        spawnHandlerFromLeaveElement((((com.fusiontech.bank.transports.impl.TransactionTransportRequestImpl)com.fusiontech.bank.transports.impl.VerifyDepositTransportRequestImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  7 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        spawnHandlerFromEnterAttribute((((com.fusiontech.bank.transports.impl.TransactionTransportRequestImpl)com.fusiontech.bank.transports.impl.VerifyDepositTransportRequestImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  7 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((com.fusiontech.bank.transports.impl.TransactionTransportRequestImpl)com.fusiontech.bank.transports.impl.VerifyDepositTransportRequestImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                    case  7 :
                ...
                try {
                    switch (state) {
                        case  5 :
                            ...
                            return ;
                        case  0 :
                            spawnHandlerFromText((((com.fusiontech.bank.transports.impl.TransactionTransportRequestImpl)com.fusiontech.bank.transports.impl.VerifyDepositTransportRequestImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                        case  7 :
