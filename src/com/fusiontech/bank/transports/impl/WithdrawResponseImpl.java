...
public class WithdrawResponseImpl
    extends com.fusiontech.bank.transports.impl.WithdrawTransportResponseImpl
    implements com.fusiontech.bank.transports.WithdrawResponse, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.fusiontech.bank.model.impl.runtime.UnmarshallableObject, com.fusiontech.bank.model.impl.runtime.XMLSerializable, com.fusiontech.bank.model.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.fusiontech.bank.transports.WithdrawResponse.class);
    }
    ...
    public com.fusiontech.bank.model.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.fusiontech.bank.model.impl.runtime.UnmarshallingContext context) {
        return new com.fusiontech.bank.transports.impl.WithdrawResponseImpl.Unmarshaller(context);
    }

    public void serializeBody(com.fusiontech.bank.model.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://www.fusiontech.com/bankservice/transports/xsd/1.0", "withdrawResponse");
...
+"\u0000Qt\u0000\u0010withdrawResponseq\u0000~\u0000[sr\u0000\"com.sun.msv.grammar.Expression"
...
+"un/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u000f\u0001pq\u0000~\u0000\rq\u0000~\u0000nq\u0000~\u0000Iq\u0000~\u0000fq\u0000"
+"~\u0000zq\u0000~\u0000\nq\u0000~\u0000~q\u0000~\u0000\\q\u0000~\u0000\u0011q\u0000~\u0000\u000bq\u0000~\u0000\tq\u0000~\u0000^q\u0000~\u0000lq\u0000~\u0000pq\u0000~\u0000qx"));
        }
        ...
        extends com.fusiontech.bank.model.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.fusiontech.bank.transports.impl.WithdrawResponseImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("errorId" == ___local)&&("http://www.fusiontech.com/bankservice/transports/xsd/1.0" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.fusiontech.bank.transports.impl.WithdrawTransportResponseImpl)com.fusiontech.bank.transports.impl.WithdrawResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        ...
                        return ;
                    case  0 :
                        if (("withdrawResponse" == ___local)&&("http://www.fusiontech.com/bankservice/transports/xsd/1.0" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.fusiontech.bank.transports.impl.WithdrawTransportResponseImpl)com.fusiontech.bank.transports.impl.WithdrawResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.fusiontech.bank.transports.impl.WithdrawTransportResponseImpl)com.fusiontech.bank.transports.impl.WithdrawResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.fusiontech.bank.transports.impl.WithdrawTransportResponseImpl)com.fusiontech.bank.transports.impl.WithdrawResponseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.fusiontech.bank.transports.impl.WithdrawTransportResponseImpl)com.fusiontech.bank.transports.impl.WithdrawResponseImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
