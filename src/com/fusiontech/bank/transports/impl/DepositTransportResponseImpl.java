...
public class DepositTransportResponseImpl
    extends com.fusiontech.bank.transports.impl.TransactionTransportResponseImpl
    implements com.fusiontech.bank.transports.DepositTransportResponse, com.sun.xml.bind.JAXBObject, com.fusiontech.bank.model.impl.runtime.UnmarshallableObject, com.fusiontech.bank.model.impl.runtime.XMLSerializable, com.fusiontech.bank.model.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.fusiontech.bank.transports.DepositTransportResponse.class);
    }
    ...
    public com.fusiontech.bank.model.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.fusiontech.bank.model.impl.runtime.UnmarshallingContext context) {
        return new com.fusiontech.bank.transports.impl.DepositTransportResponseImpl.Unmarshaller(context);
    }
...
+"\u0006q\u0000~\u0000\\q\u0000~\u0000jq\u0000~\u0000nq\u0000~\u0000ox"));
        ...
        extends com.fusiontech.bank.model.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.fusiontech.bank.transports.impl.DepositTransportResponseImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  0 :
                        if (("errorId" == ___local)&&("http://www.fusiontech.com/bankservice/transports/xsd/1.0" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.fusiontech.bank.transports.impl.TransactionTransportResponseImpl)com.fusiontech.bank.transports.impl.DepositTransportResponseImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveElement((((com.fusiontech.bank.transports.impl.TransactionTransportResponseImpl)com.fusiontech.bank.transports.impl.DepositTransportResponseImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromEnterAttribute((((com.fusiontech.bank.transports.impl.TransactionTransportResponseImpl)com.fusiontech.bank.transports.impl.DepositTransportResponseImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        return ;
                    case  0 :
                        spawnHandlerFromLeaveAttribute((((com.fusiontech.bank.transports.impl.TransactionTransportResponseImpl)com.fusiontech.bank.transports.impl.DepositTransportResponseImpl.this).new Unmarshaller(context)), 1, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  1 :
                            ...
                            return ;
                        case  0 :
                            spawnHandlerFromText((((com.fusiontech.bank.transports.impl.TransactionTransportResponseImpl)com.fusiontech.bank.transports.impl.DepositTransportResponseImpl.this).new Unmarshaller(context)), 1, value);
                            return ;
                    }
